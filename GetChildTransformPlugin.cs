...
namespace veasu.transform {
  [PluginType(Id = "com.veasu.childtransformplugin", Name = "Child Transform Node", Version = "0.1.0", Author = "Veasu", Description = "A quick and dirty node to get the transform of a prop", Icon = @"<svg version=""1.0"" xmlns=""http://www.w3.org/2000/svg""
  ...
  148 49 152 0 5 -8 8 -18 8 -14 0 -27 -28 -59 -126z""/>
      ...
      NodeTypes = new[] { typeof(GetChildTransformNode) })]
  public class GetChildTransformPlugin : Plugin {

      [Markdown(primary: true)]
      public string Info = "A quick and dirty node to get the transform of a prop.";
